...
from lavis.datasets.datasets.mc_video_vqa_datasets import MCVideoQADataset, EventMCVideoQADataset, EventOEVideoQADataset
...
class EventMCVideoQABuilder(BaseDatasetBuilder):
    train_dataset_cls = EventMCVideoQADataset
    eval_dataset_cls = EventMCVideoQADataset
...
class EventOEVideoQABuilder(BaseDatasetBuilder):
    train_dataset_cls = EventOEVideoQADataset
    eval_dataset_cls = EventOEVideoQADataset
...
@registry.register_builder("egotaskqa")
class EgotaskQABuilder(EventOEVideoQABuilder):
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/egotaskqa/defaults_qa.yaml",
    }
    
    
@registry.register_builder("star")
class STARBuilder(EventMCVideoQABuilder):
    DATASET_CONFIG_DICT = {
